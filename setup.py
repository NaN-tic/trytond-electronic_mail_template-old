...
name = 'trytonzz_electronic_mail_template'
...
setup(name=name,
    version=version,
    description='Tryton Electronic Mail Template Module',
    ...
    entry_points="""
    [trytond.modules]
    electronic_mail_template = trytond.modules.electronic_mail_template
    """,
    test_suite='tests',
